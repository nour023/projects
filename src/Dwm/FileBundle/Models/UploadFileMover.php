...
namespace Dwm\FileBundle\Models;
use BabySitting\UsersBundle\Entity\Utilisateur;
...
class UploadFileMover {
    ...
    public function moveUploadedFile(UploadedFile $file, $uploadBasePath,$relativePath) {
        ...
        $uploadBasePath1="C:/wamp/www/gif/";
       ...
       // $relativePath = date('Y-m', filemtime($file->getPath()));
        ...
        $targetFilePath = $uploadBasePath1 . DIRECTORY_SEPARATOR . $targetFileName;
        echo $originalName;
